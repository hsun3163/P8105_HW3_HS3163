...
```{r pb2 pt 2}
brfss_smart2010_tidy_filtered<-brfss_smart2010_tidy%>%
  filter(topic == "Overall Health" )
```

* include only responses from “Excellent” to “Poor”
```{r pb2 pt 3}
brfss_smart2010_tidy_filtered%>%
...
brfss_smart2010_tidy_finished<-brfss_smart2010_tidy_filtered%>%
...
```{r pb2 pt 5.1}
states_2002<-brfss_smart2010_tidy_finished%>%
...
```{r pb2 pt 5.2}
states_2010<-brfss_smart2010_tidy_finished%>%
###Only intersted in year 2002 and 2010
  group_by(year,state_abbr,counties_and_cities)%>%summarise()%>%
  count(year,state_abbr)%>%
  filter(n>= 7)%>%
